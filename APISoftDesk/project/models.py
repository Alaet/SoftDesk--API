...
class Issue(models.Model):
    """
    Related to a Project by foreignKey, hold comment and reference to every id contributor through author_user_id
    """
    TAG_CHOICES = (
        ('BUG', 'BUG'),
        ('UPD', 'AMELIORATION'),
    ...
    author_user_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name="issues_author")
    assignee_user_id = models.ForeignKey(User, on_delete=models.CASCADE, null=True, related_name="issues_assignee",
...
class Project(models.Model):
    ...
    contributor = models.ManyToManyField(User, through='Contributors', related_name='contributor')
...
class Comment(models.Model):
    ...
    """
    description = models.CharField(max_length=1200)
    author_user_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='comments')
